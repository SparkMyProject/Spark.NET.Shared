...
public class RegisterReqModel
{
    ...
    [Required(ErrorMessage = "A FirstName is required.")] public string? FirstName { get; set; }
    [Required(ErrorMessage = "A Lastname is required.")] public string? LastName { get; set; }
